import { getDateUtils, getFullYear } from "@/lib/dateUtils";
import getImagePath from "@/lib/getImagePath";
import { TVShowDetail } from "@/types/TVType";
...
const TvDetailSection = ({data, trailerKey}: Props) => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:space-x-10 space-y-4 items-center">
          ...
          <div className="flex flex-col items-start space-y-4">
            <div className="flex items-center space-x-2">
              <p className="text-4xl text-white">{data.original_name} <span className="text-gray-400">({getFullYear(data.first_air_date)})</span></p>
            </div>
